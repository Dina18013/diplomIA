...
public class DataHelper {
    ...
    public static CardInfo getFifteenNumberCardNumber() {   //номер карты 15шт
    ...
    public static CardInfo getPlusSixYearInField() {             //год более 5
        return new CardInfo(approvedCard, getValidMonth(), getPlusSixYear(), getOwner(), getCVC());
    }


    public static CardInfo getSpecialSymbolInFieldName() {            //спец символы
        return new CardInfo(approvedCard, getValidMonth(), getValidYear(), getSpecialSymbol(), getCVC());
    }

    public static CardInfo getNumberInFieldName() {                 //в имени цифры
    ...
    public static CardInfo getRusName() {                         //имя рус
